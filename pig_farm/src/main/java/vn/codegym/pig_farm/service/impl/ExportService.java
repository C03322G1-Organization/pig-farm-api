...
public class ExportService implements IExportService {
    ...
    public void create(vn.codegym.pig_farm.dto.ExportDto exportDto) {
        iExportRepository.create(exportDto.getPigstyDto().getId(), exportDto.getEmployeeDto().getId(), exportDto.getCodeExport(), exportDto.getCompany(), exportDto.getPrice(), exportDto.getTypePigs(), exportDto.getAmount(), exportDto.getKilogram());
    }
    ...
    public void update(Export export) {
        iExportRepository.update(export.getPigsty(), export.getEmployee(), export.getCodeExport(), export.getCompany(), export.getPrice(), export.getTypePigs(), export.getAmount(), export.getKilogram(), export.getId());
    }
